...
export class InsideImageService {
  ...
  deleteImageSource$ : Observable<number> = this.deleteImageSource.asObservable();
  ...
  deleteImage(imageId : number){
    this.deleteImageSource.next(imageId);
  }
}
